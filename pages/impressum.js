    ...
    return(
        <>
         <h1>Impressum</h1>
            ...
            <p></p>
            <h3>Richtigkeit, Korrekturen</h3>
            <p>Für die Richtigkeit der über die vorliegende Website Sell my Campus verbreiteten Informationen und Ansichten, einschliesslich Informationen auf dieser Webseite 
                wird keine Gewähr geleistet, weder ausdrücklich noch implizit. Die Betreiber der Webseite unternehmen alle Schritte um die Zuverlässigkeit der präsentierten Informationen zu gewährleisten, doch machen sie keinerlei Zusagen über die Korrektheit, 
                Zuverlässigkeit, Vollständigkeit und Aktualität der auf der Website enthaltenen Informationen, Angaben und Ansichten.
                Anmerkungen und Rückmeldungen können eingereicht werden.</p>
            <h3>Haftung</h3>
            <p>In keinem Fall, Fahrlässigkeit uneingeschränkt eingeschlossen, haften die Autoren für Verluste oder Schäden irgendwelcher Art; 
            ...
            <p>Die vorliegende Webseite wurde im Rahmen des Projektmoduls im ICT-Campus der Post AG, Engelhaldenstrasse 26 in 3030 Bern entwickelt.
                ...
                <ul>
                    <li>Andrea Engel, andrea.engel@ict-campus.net</li>
                    <li>Andrin Renggli, andrin.renggli@ict-campus.net</li>
                    <li>Nicola Walker, nicola.walker@ict-campus.net</li>
                </ul>
            <p>
                Für Fragen oder Anmerkungen können die Autoren unter den obenstehenden E-Mail-Adressen erreicht werden. 
            </p>
            <p>Hier geht es <a href="/">zurück zur Startseite</a>.</p>
        </>
    )
}